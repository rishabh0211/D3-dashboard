...
const BarChart = function (_parentElement, _variable, _title, data) {
...
BarChart.prototype.initVis = function () {
  ...
  vis.color = d3.scaleOrdinal(d3.schemeReds[4]);
...
BarChart.prototype.wrangleData = function (nestedCalls) {
  var vis = this;
...
BarChart.prototype.updateVis = function () {
  ...
  // Update scales
  vis.y.domain([0, d3.max(vis.dataFiltered, (d) => {
    return +d.size;
  })]);
