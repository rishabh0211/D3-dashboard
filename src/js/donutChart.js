...
const DonutChart = function (_parentElement, _variable, data) {
...
DonutChart.prototype.wrangleData = function (data) {
	var vis = this;

	let sizeNest = d3.nest()
		.key(function (d) {
...
DonutChart.prototype.addLegend = function () {
	...
	var legendArray = [{
			label: "Small",
			color: vis.color("small")
		},
		{
			label: "Medium",
			color: vis.color("medium")
		},
		{
			label: "Large",
			color: vis.color("large")
		}
	];
